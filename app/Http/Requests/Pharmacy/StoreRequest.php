...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'work_start' => 'required|date_format:H:i', // Формат времени ЧЧ:ММ
            'work_end' => 'required|date_format:H:i|after:work_start', // Формат ЧЧ:ММ и должно быть после начала работы
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'work_start.date_format' => 'Поле Время начала работы должно быть в формате HH:MM',
            'work_end.required' => 'Поле Время окончания работы обязательно для заполнения',
            'work_end.date_format' => 'Поле Время окончания работы должно быть в формате HH:MM',
