...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Результаты поиска аптек по запросу "{{ $searchQuery }}"</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('pharmacy.index') }}" class="btn btn-secondary">Назад</a>
                    </div>
                    ...
                    <div class="card-footer clearfix">
                        <div class="pagination pagination-sm m-0 float-right">
                            {{ $pharmacies->appends(['search' => $searchQuery])->links() }}
                        </div>
                    </div>
